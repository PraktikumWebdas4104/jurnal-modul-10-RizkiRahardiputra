...
return $this->execute($query);
		...
		function updateMhs($nim, $nama, $angkatan, $fakultas, $prodi){
			...
			$query=	"UPDATE mahasiswa SET nama= '$nama', angkatan= '$angkatan', fakultas = '$fakultas', prodi = '$prodi' WHERE nim = '$nim'";
return $this->execute($query);
		}
		...
		function insertMhs($nim, $nama, $angkatan, $fakultas, $prodi){
			...
			$query="INSERT INTO mahasiswa (nim, nama, angkatan, fakultas, prodi) VALUES ('$nim', '$nama', '$angkatan', '$fakultas', '$prodi')";
			return $this->execute($query);
		}
